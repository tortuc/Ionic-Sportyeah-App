...
@Component({
  selector: 'ranking-month',
  templateUrl: './ranking-month.component.html',
  styleUrls: ['./ranking-month.component.scss'],
})
export class RankingMonthComponent implements OnInit , OnChanges {
  ...
  getData(){
    let country = 'null'
    this.dayStart = moment(new Date).startOf('month').format('YYYY-MM-DD')
    this.dayEnd = moment(new Date).endOf('month').format('YYYY-MM-DD')
