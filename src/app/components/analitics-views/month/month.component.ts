...
// monthsPdf = ["jan","feb" ,"mar" ,"apr" ,"may" ,"jun" ,"jul" ,"agu" ,"sep" ,"oct" ,"nov" ,"dic" ]
// ok=false;
//  takeDataMonthPdf() {
//     let month = moment().startOf("year")
//     for(let element of this.monthsPdf){
//     this.viewsSponsorService
//       .getVisitsByMonth(this.userService.User._id, month, "search")
//       .pipe(take(1))
//       .subscribe((response: any) => {
//         if (response.length == 0) {
//           this.dataSearch = [0, 0, 0, 0, 0, 0, 0];
...
//         }
//         this.viewsSponsorService
//           .getVisitsByMonth(this.userService.User._id, month, "post")
//           .pipe(take(1))
//           .subscribe((response: any) => {
//             if (response.length == 0) {
//               this.dataPost = [0, 0, 0, 0, 0, 0, 0];
...
//                       this.dataSearch = response;
//                     }
//                     this.linesDataMonthsPdf(element);
//                   });
//               });
//           });
//       });
...
//   linesDataMonthsPdf(month) {

//     let linesSponsorPdf
//     this.cd.detectChanges();

//     let dataPost = this.dataPost;
//     let dataChat = this.dataChat;
//     let dataSearch = this.dataSearch;
//     let dataProfile = this.dataProfile;
//     let dataComment = this.dataComment;
//     let dataNews = this.dataNews;
//     console.log(month);
//     console.log(this.dataPost);
//     linesSponsorPdf = new Chart(month, {
//       type: "line",
//       data: {
//         labels: this.labelMonths,
//         datasets: [
